...
function PublicDigitalCard() {
  ...
  useEffect(() => {
    if (q.data) trackStudioClientEvent({ eventName: "digital_card_view", shareToken: token });
  }, [q.data, token]);
  ...
  async function share() {
    ...
    try {
      ...
      trackStudioClientEvent({ eventName: "digital_card_share", shareToken: token });
  ...
  function downloadVCard() {
    ...
    trackStudioClientEvent({ eventName: "digital_card_save_contact", shareToken: token });
  }
