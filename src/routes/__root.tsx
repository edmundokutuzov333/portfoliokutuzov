...
const earlyLocaleScript = `(function(){try{var l=localStorage.getItem("ek_locale_v2");if(l==="pt-PT")document.documentElement.lang="pt-PT";}catch(_){}})();`;
...
const structuredData = JSON.stringify({
  ...
  "@graph": [
    ...
    },
    {
      ...
      name: "Edmundo Kutuzov",
      description:
        "Portfolio of art direction, visual identities, campaigns and digital experiences.",
      inLanguage: "en",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head suppressHydrationWarning>
        <HeadContent />
        <script dangerouslySetInnerHTML={{ __html: earlyLocaleScript }} />
