...
export function Manifesto() {
  ...
  const principles = r<Principle[]>("principles", []);
      ...
      <div className="mx-auto max-w-[1240px]">
        <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:gap-16">
          ...
          <div>
            ...
            >
              <span className="text-metal">{r("title_1", "")}</span>{" "}
              <span className="text-sky-200">{r("title_accent", "")}</span>{" "}
              <span className="text-metal">{r("title_2", "")}</span>{" "}
              <span className="text-slate-500">{r("title_muted", "")}</span>
            </motion.h2>
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-2 md:gap-14">
              <p className="text-[15px] leading-7 text-slate-400 md:text-base">{r("col1", "")}</p>
              <p className="text-[15px] leading-7 text-slate-400 md:text-base">{r("col2", "")}</p>
            </div>
          </div>
        </div>
