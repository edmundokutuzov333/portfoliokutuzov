...
const PT_COMPLETION: TranslationMap = {
  ...
  "Motion Content": "Conteúdo de motion",
  "Web Design": "Design web",
  "Image Manipulation": "Tratamento de imagem",
  "Video Direction": "Direcção de vídeo",
  ...
  Currency: "Moeda",
  "Preferred billing currency": "Moeda de facturação preferida",
  "Estimated Scope Bracket": "Faixa estimada do projecto",
  "Select the tier that best fits": "Seleccione a faixa que melhor se adequa",
  "Or an Exact Figure": "Ou um valor exacto",
  "Optional target amount": "Valor pretendido opcional",
  "Budget is negotiable based on scope & deliverables": "O orçamento é negociável em função do âmbito e das entregas",
  "Target Launch / Delivery Date": "Data prevista de lançamento / entrega",
  "Optional project deadline": "Prazo opcional do projecto",
  "Preferred Contact Channel": "Canal de contacto preferido",
  "How would you like to receive the proposal?": "Como prefere receber a proposta?",
  "All briefings and shared information are strictly confidential and protected under standard studio NDA standards.": "Todos os briefings e as informações partilhadas são estritamente confidenciais e protegidos pelas normas habituais de confidencialidade do estúdio.",
  "Project Description & Vision": "Descrição e visão do projecto",
  "The challenge, goals and deliverables": "O desafio, os objectivos e as entregas",
  "Visual Attachments": "Anexos visuais",
  "Max 8 MB images": "Imagens até 8 MB",
  "Upload images / brand assets": "Carregar imagens / materiais da marca",
  "Uploading...": "A carregar...",
  "Moodboards / Reference URLs": "Moodboards / URLs de referência",
  "Behance, Figma, Drive, Pinterest": "Behance, Figma, Drive, Pinterest",
  Add: "Adicionar",
  Back: "Voltar",
  "Transmitting Brief...": "A enviar o briefing...",
