...
export {
  ...
  transform as a0,
  attachFollow as a1,
  hasReducedMotionListener as a2,
  initPrefersReducedMotion as a3,
  prefersReducedMotion as a4,
  resolveElements as a5,
  createGeneratorEasing as a6,
  fillOffset as a7,
  isGenerator as a8,
  isSVGElement as a9,
  isSVGSVGElement as aa,
  visualElementStore as ab,
  ObjectVisualElement as ac,
  animateSingleValue as ad,
  animateTarget as ae,
  spring as af,
  GroupAnimationWithThen as ag,
