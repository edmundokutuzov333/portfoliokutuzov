...
const homepage = "https://github.com/googleapis/google-cloud-node/tree/main/core/packages/gaxios";
const require$$0 = {
  name,
  version,
  description,
    ...
    function defaultErrorRedactor(data) {
      ...
      function redactObject(obj) {
        if (!obj || typeof obj !== "object") {
          ...
          obj instanceof URLSearchParams || // support `node-fetch` FormData/URLSearchParams
  ...
  class Gaxios {
    ...
    async #prepareRequest(options) {
      ...
      const shouldDirectlyPassData =
        ...
        opts.data instanceof Blob || // Node 18 does not have a global `File` object
...
`;
    ...
    static async #getProxyAgent() {
      this.#proxyAgent ||= (
        await import("./https-proxy-agent.mjs").then(function (n) {
          return n.i;
        })
      ).HttpsProxyAgent;
