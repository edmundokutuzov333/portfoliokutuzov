...
function requireLoggingUtils() {
  ...
  (function (exports) {
    var __createBinding =
      (loggingUtils && loggingUtils.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
    ...
    var __setModuleDefault =
      (loggingUtils && loggingUtils.__setModuleDefault) ||
      (Object.create
        ? function (o, v) {
    ...
    var __importStar =
      (loggingUtils && loggingUtils.__importStar) ||
      /* @__PURE__ */ (function () {
    ...
    class DebugLogBackendBase {
      constructor() {
        ...
        let nodeFlag =
          (_a = process2.env[exports.env.nodeEnables]) !== null && _a !== void 0 ? _a : "*";
        if (nodeFlag === "all") {
          nodeFlag = "*";
        }
    ...
    class DebugBackend extends DebugLogBackendBase {
      ...
      setFilters() {
        ...
        const existingFilters =
          (_a = process2.env["NODE_DEBUG"]) !== null && _a !== void 0 ? _a : "";
        process2.env["NODE_DEBUG"] =
    ...
    class StructuredBackend extends DebugLogBackendBase {
      ...
      makeLogger(namespace) {
        ...
        return (fields, ...args) => {
          var _a2;
          const severity =
            (_a2 = fields.severity) !== null && _a2 !== void 0 ? _a2 : LogSeverity.INFO;
    ...
    function log(namespace, parent) {
      ...
      const logger = (() => {
        ...
        const newLogger = new AdhocDebugLogger(namespace, (fields, ...args) => {
          ...
          cachedBackend === null || cachedBackend === void 0
            ? void 0
