...
import {
  r as requireJsonSchemaTraverse,
  a as requireJsonSchemaTraverse$1,
} from "./json-schema-traverse.mjs";
  ...
  (function (exports) {
    ...
    class If extends BlockNode {
      ...
      optimizeNames(names2, constants) {
        var _a;
        this.else =
          (_a = this.else) === null || _a === void 0 ? void 0 : _a.optimizeNames(names2, constants);
    ...
    function optimizeExpr(expr, names2, constants) {
      ...
      function canOptimize(e) {
        return (
          ...
          e._items.some(
            (c) => c instanceof code_1.Name && names2[c.str] === 1 && constants[c.str] !== void 0,
          )
        );
      }
    }
...
function requireUtil$1() {
  ...
  util$1.checkStrictMode =
    util$1.getErrorPath =
    util$1.Type =
    util$1.useFunc =
    util$1.setEvaluated =
    util$1.evaluatedPropsToName =
    ...
    util$1.schemaRefOrVal =
    util$1.schemaHasRulesButRef =
    util$1.schemaHasRules =
    util$1.checkUnknownRules =
    util$1.alwaysValidSchema =
    util$1.toHash =
      void 0;
  ...
  (function (exports) {
    ...
    exports.keyword$DataError = {
      message: ({ keyword: keyword2, schemaType }) =>
        schemaType
          ? (0, codegen_1.str)`"${keyword2}" keyword must be ${schemaType} ($data)`
...
function requireApplicability$1() {
  ...
  applicability$1.shouldUseRule =
    applicability$1.shouldUseGroup =
    applicability$1.schemaHasRulesForType =
      void 0;
...
function requireDataType$1() {
  ...
  dataType$1.reportTypeError =
    dataType$1.checkDataTypes =
    dataType$1.checkDataType =
    dataType$1.coerceAndCheckDataType =
    dataType$1.getJSONTypes =
    dataType$1.getSchemaTypes =
    dataType$1.DataType =
      void 0;
  ...
  function coerceData(it, types2, coerceTo) {
    ...
    if (opts.coerceTypes === "array") {
      gen.if(
        (0, codegen_1._)`${dataType2} == 'object' && Array.isArray(${data}) && ${data}.length == 1`,
        () =>
          gen
    ...
    function coerceSpecificType(t) {
      switch (t) {
        case "string":
          gen
            .elseIf((0, codegen_1._)`${dataType2} == "number" || ${dataType2} == "boolean"`)
        ...
        case "array":
          gen
            .elseIf(
              (0, codegen_1._)`${dataType2} === "string" || ${dataType2} === "number"
...
function requireCode$2() {
  ...
  code$2.validateUnion =
    code$2.validateArray =
    code$2.usePattern =
    code$2.callValidateCode =
    code$2.schemaProperties =
    code$2.allSchemaProperties =
    code$2.noPropertyInData =
    code$2.propertyInData =
    code$2.isOwnProperty =
    code$2.hasPropFunc =
    code$2.reportMissingProp =
    code$2.checkMissingProp =
    code$2.checkReportMissingProp =
      void 0;
  const codegen_1 = /* @__PURE__ */ requireCodegen$1();
  const util_1 = /* @__PURE__ */ requireUtil$1();
  const names_1 = /* @__PURE__ */ requireNames$1();
...
function requireSubschema$1() {
  ...
  subschema$1.extendSubschemaMode =
    subschema$1.extendSubschemaData =
    subschema$1.getSubschema =
      void 0;
  const codegen_1 = /* @__PURE__ */ requireCodegen$1();
  const util_1 = /* @__PURE__ */ requireUtil$1();
  function getSubschema(
    it,
    { keyword: keyword2, schemaProp, schema, schemaPath, errSchemaPath, topSchemaRef },
  ) {
...
function requireResolve$1() {
  ...
  resolve$1.getSchemaRefs =
    resolve$1.resolveUrl =
    resolve$1.normalizeId =
    resolve$1._getFullPath =
    resolve$1.getFullPath =
    resolve$1.inlineRef =
      void 0;
  const util_1 = /* @__PURE__ */ requireUtil$1();
...
function requireValidate$1() {
  ...
  function assignEvaluated({ gen, evaluated, props, items: items2 }) {
    ...
    if (items2 instanceof codegen_1.Name) gen.assign((0, codegen_1._)`${evaluated}.items`, items2);
  }
...
function requireCompile$1() {
  ...
  compile$1.resolveSchema =
    compile$1.getCompilingSchema =
    compile$1.resolveRef =
    compile$1.compileSchema =
    compile$1.SchemaEnv =
      void 0;
  const codegen_1 = /* @__PURE__ */ requireCodegen$1();
...
function requireLimitNumber$1() {
  ...
  const def = {
    ...
    code(cxt) {
      ...
      cxt.fail$data(
        (0, codegen_1._)`${data} ${KWDs[keyword2].fail} ${schemaCode} || isNaN(${data})`,
      );
    },
  };
...
function requireItems2020$1() {
  ...
  const def = {
    ...
    code(cxt) {
      ...
      it.items = true;
      if ((0, util_1.alwaysValidSchema)(it, schema)) return;
      if (prefixItems2) (0, additionalItems_1.validateAdditionalItems)(cxt, prefixItems2);
      ...
      function validate$DataFormat() {
        ...
        function invalidFmt() {
          const callFormat = schemaEnv.$async
            ? (0, codegen_1._)`(${fDef}.async ? await ${format2}(${data}) : ${format2}(${data}))`
...
export { Ajv as A, requireAjv as a, requireCodegen as r };
