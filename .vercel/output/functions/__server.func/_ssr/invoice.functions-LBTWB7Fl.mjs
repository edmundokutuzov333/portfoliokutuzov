import { f as createSsrRpc } from "./router-BjVSvuz8.mjs";
...
const saveInvoiceDraft = createServerFn({
  ...
  .handler(createSsrRpc("3358006f6a9d9625853af82d6e7df3a54258f0523ceffb01a5019a701a84bc88"));
const getInvoiceDraft = createServerFn({
  method: "POST",
})
  .middleware([requireSupabaseAuth])
  .inputValidator((i) => IdSchema.parse(i))
  .handler(createSsrRpc("88c916531dc078a3249f92545c6b038e50f33c99c9111d2292882c8fdf8655ec"));
const renderInvoicePdfNow = createServerFn({
  method: "POST",
})
  .middleware([requireSupabaseAuth])
  .inputValidator((i) => DraftSchema.parse(i))
  .handler(createSsrRpc("79fad9d37613ae3016f5456c130980d6d5734c953a5cd0744579762c546f167b"));
const generateBriefingInvoice = createServerFn({
  method: "POST",
})
  .middleware([requireSupabaseAuth])
  .inputValidator((i) => DraftSchema.parse(i))
  .handler(createSsrRpc("02549197a893ac72fe11ed98120318300b203d66ec24779eb25529bbb5668ee2"));
const previewInvoiceEmail = createServerFn({
  ...
  .handler(createSsrRpc("1903ed2e0c27bfc3ee700bbb0c7b7d812516f97e0fecfc6ce6030e38e5449bd4"));
...
const sendBriefingInvoice = createServerFn({
  ...
  .handler(createSsrRpc("54f48f86b3b05004ee82bbe667b59e39934b23c9ab345cbfca482f40f3275d5e"));
const setInvoiceStatus = createServerFn({
  ...
  .handler(createSsrRpc("a3199d2d8d9bc2ca06a4ed0fdd2a1adda6ac21def1962dedbc85f54d8362ead6"));
const listInvoiceEvents = createServerFn({
  method: "POST",
})
  .middleware([requireSupabaseAuth])
  .inputValidator((i) => IdSchema.parse(i))
  .handler(createSsrRpc("3df214823d15024d62cdacc52b9ca2675512f5b87909e9277061f1f686b791c2"));
const getInvoiceWorkspace = createServerFn({
  method: "POST",
})
  .middleware([requireSupabaseAuth])
  .handler(createSsrRpc("b75f10f4d5470089dbbfd03639ced843095b6501e58fbf2bbcf624831011f069"));
const getPublicInvoice = createServerFn({
  method: "POST",
})
  .inputValidator((i) => TokenSchema.parse(i))
  .handler(createSsrRpc("7cf99f1f443df70951f16026984e7f7a664d02eb63efa6624ccde1f1d6e46144"));
const createProofUploadUrl = createServerFn({
  ...
  .handler(createSsrRpc("a7e3b9e9169c200b8ece514744acb9313a0c683d5343989dfb3529da8bfc31e6"));
const reportInvoicePayment = createServerFn({
  ...
  .handler(createSsrRpc("34eb708ad10955c4086cd44b7d0ad65b10e6df7bc6d5ec0f3ed0b116135766f6"));
export {
