import { c as createServerRpc } from "./createServerRpc-D1NXXGIT.mjs";
import { c as createServerFn } from "./server-L5kFO_hB.mjs";
import { r as requireSupabaseAuth } from "./auth-middleware-BwKKCkXn.mjs";
...
const saveInvoiceDraft = createServerFn({
  ...
  .inputValidator((i) => DraftSchema.parse(i))
  .handler(saveInvoiceDraft_createServerFn_handler, async ({ data, context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { error: updErr } = await supabaseAdmin
      .from("briefing_submissions")
      .update({
        invoice_currency: data.currency,
        invoice_issue_date:
          data.issue_date ?? /* @__PURE__ */ new Date().toISOString().slice(0, 10),
...
const getInvoiceDraft = createServerFn({
  ...
  .handler(getInvoiceDraft_createServerFn_handler, async ({ data, context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
...
const renderInvoicePdfNow = createServerFn({
  ...
  .middleware([requireSupabaseAuth])
  .inputValidator((i) => DraftSchema.parse(i))
  .handler(renderInvoicePdfNow_createServerFn_handler, async ({ data, context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { data: brief, error } = await supabaseAdmin
...
const generateBriefingInvoice = createServerFn({
  ...
  .middleware([requireSupabaseAuth])
  .inputValidator((i) => DraftSchema.parse(i))
  .handler(generateBriefingInvoice_createServerFn_handler, async ({ data, context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { error: delErr } = await supabaseAdmin
    ...
    const { error: upErr } = await supabaseAdmin.storage.from(S.PDF_BUCKET).upload(pdfPath, bytes, {
...
const previewInvoiceEmail = createServerFn({
  ...
  .handler(previewInvoiceEmail_createServerFn_handler, async ({ data, context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { data: brief, error } = await supabaseAdmin
...
const sendBriefingInvoice = createServerFn({
  ...
  .handler(sendBriefingInvoice_createServerFn_handler, async ({ data, context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { data: brief, error } = await supabaseAdmin
...
const setInvoiceStatus = createServerFn({
  ...
  .handler(setInvoiceStatus_createServerFn_handler, async ({ data, context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const patch = {
...
const listInvoiceEvents = createServerFn({
  ...
  .middleware([requireSupabaseAuth])
  .inputValidator((i) => IdSchema.parse(i))
  .handler(listInvoiceEvents_createServerFn_handler, async ({ data, context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
...
const getInvoiceWorkspace = createServerFn({
  ...
  .middleware([requireSupabaseAuth])
  .handler(getInvoiceWorkspace_createServerFn_handler, async ({ context }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    await S.assertAdmin(context);
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { data: rows, error } = await supabaseAdmin
...
const getPublicInvoice = createServerFn({
  ...
  .handler(getPublicInvoice_createServerFn_handler, async ({ data }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { data: brief, error } = await supabaseAdmin
      .from("briefing_submissions")
...
const createProofUploadUrl = createServerFn({
  ...
  .handler(createProofUploadUrl_createServerFn_handler, async ({ data }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { data: brief, error } = await supabaseAdmin
      .from("briefing_submissions")
...
const reportInvoicePayment = createServerFn({
  ...
  .handler(reportInvoicePayment_createServerFn_handler, async ({ data }) => {
    const S = await import("./invoice.server-DadR8m2V.mjs");
    const { supabaseAdmin } = await import("./client.server-QKU_nCTE.mjs");
    const { data: brief, error } = await supabaseAdmin
      .from("briefing_submissions")
