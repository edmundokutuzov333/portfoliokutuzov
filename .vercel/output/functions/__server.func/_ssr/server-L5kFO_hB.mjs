...
import {
  w as defineHandlerCallback,
  x as resolveManifestAssetLink,
  s as resolveManifestCssLink,
  k as rootRouteId,
  y as getNormalizedURL,
  z as getOrigin,
  A as waitForRequest,
  C as bindSsrResponseToRequest,
  D as normalizeSsrResponse,
  E as attachRouterServerSsrUtils,
  F as _getRenderedMatches,
  G as createSerializationAdapter,
  H as createRawStreamRPCPlugin,
  i as invariant,
  g as isNotFound,
  I as isRedirect,
  J as isResolvedRedirect,
  K as replaceSsrResponse,
  L as mergeHeaders,
  M as isSsrResponse,
  N as disposeSsrResponseDetached,
  O as executeRewriteInput,
  P as stripSsrResponseBody,
  Q as defaultSerovalPlugins,
  S as makeSerovalPlugin,
  p as getScriptPreloadAttrs,
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D4s0KFej.mjs");
...
const manifest = {
  "02549197a893ac72fe11ed98120318300b203d66ec24779eb25529bbb5668ee2": {
    functionName: "generateBriefingInvoice_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  "0950b9567811d33822a6d68cdb42a67e24a6c66d84e085f282580cea5664330f": {
    functionName: "sendBriefingEmails_createServerFn_handler",
    importer: () => import("./briefing.functions-mvjeJ5Yc.mjs"),
  },
  "1903ed2e0c27bfc3ee700bbb0c7b7d812516f97e0fecfc6ce6030e38e5449bd4": {
    functionName: "previewInvoiceEmail_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  "3358006f6a9d9625853af82d6e7df3a54258f0523ceffb01a5019a701a84bc88": {
    functionName: "saveInvoiceDraft_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  "34eb708ad10955c4086cd44b7d0ad65b10e6df7bc6d5ec0f3ed0b116135766f6": {
    functionName: "reportInvoicePayment_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  "3df214823d15024d62cdacc52b9ca2675512f5b87909e9277061f1f686b791c2": {
    functionName: "listInvoiceEvents_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  "54f48f86b3b05004ee82bbe667b59e39934b23c9ab345cbfca482f40f3275d5e": {
    functionName: "sendBriefingInvoice_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  "79fad9d37613ae3016f5456c130980d6d5734c953a5cd0744579762c546f167b": {
    functionName: "renderInvoicePdfNow_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  "7cf99f1f443df70951f16026984e7f7a664d02eb63efa6624ccde1f1d6e46144": {
    functionName: "getPublicInvoice_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  "88c916531dc078a3249f92545c6b038e50f33c99c9111d2292882c8fdf8655ec": {
    functionName: "getInvoiceDraft_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  a3199d2d8d9bc2ca06a4ed0fdd2a1adda6ac21def1962dedbc85f54d8362ead6: {
    functionName: "setInvoiceStatus_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  a7e3b9e9169c200b8ece514744acb9313a0c683d5343989dfb3529da8bfc31e6: {
    functionName: "createProofUploadUrl_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  b75f10f4d5470089dbbfd03639ced843095b6501e58fbf2bbcf624831011f069: {
    functionName: "getInvoiceWorkspace_createServerFn_handler",
    importer: () => import("./invoice.functions-CppMQmFL.mjs"),
  },
  d1aab19b2ab28150ceb2b590995b3418b900aba58952db73f4f1c665ca4d5782: {
    functionName: "subscribeNewsletter_createServerFn_handler",
    importer: () => import("./newsletter.functions-CNJv3IiU.mjs"),
  },
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BjVSvuz8.mjs").then((n) => n.z),
    import("./start-CbiLodPz.mjs"),
