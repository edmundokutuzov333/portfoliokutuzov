...
function ContextualCursor() {
          ...
          jsxDevRuntimeExports.Fragment,
          {
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                "span",
                {
                  className: "mono text-[10px] font-bold tracking-[0.2em] uppercase",
                  children: "VIEW",
                },
                void 0,
                false,
        ...
        return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          jsxDevRuntimeExports.Fragment,
          {
            children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                Play,
                { size: 11, strokeWidth: 2.2, className: "fill-current translate-x-[1px]" },
                void 0,
                false,
                {
                  fileName: "/app/applet/src/components/portfolio/ContextualCursor.tsx",
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    motion.div,
    {
      ...
      className:
        "pointer-events-none fixed z-[9999] hidden md:flex items-center gap-1.5 rounded-full border border-sky-400/40 bg-[var(--color-bg)]/90 px-3.5 py-1.5 text-white shadow-[0_8px_32px_rgba(0,0,0,0.6)] backdrop-blur-md",
