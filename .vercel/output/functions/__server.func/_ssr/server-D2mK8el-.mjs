...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ar0KB9_K.mjs");
...
const manifest = {
  ...
  "d1aab19b2ab28150ceb2b590995b3418b900aba58952db73f4f1c665ca4d5782": {
    ...
    importer: () => import("./newsletter.functions-9qNiv4mM.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DUKWfrGf.mjs").then((n) => n.z),
    import("./start-BlZvCf3w.mjs"),
