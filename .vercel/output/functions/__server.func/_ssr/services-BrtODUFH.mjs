...
import { a as useProjects } from "./router-BjVSvuz8.mjs";
...
function ServicesInteractive() {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    "section",
    {
      ...
      className:
        "relative px-4 md:px-8 py-16 md:py-24 bg-[var(--color-bg)] text-[var(--color-text-primary)]",
      children: [
        !reducedMotion &&
          isHoveringList &&
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            motion.div,
            {
              "aria-hidden": "true",
              className:
                "pointer-events-none fixed z-50 hidden lg:flex items-center gap-1.5 rounded-full bg-sky-400 text-black px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-wider shadow-[0_0_24px_rgba(56,189,248,0.4)] backdrop-blur-md",
              style: {
                left: 0,
                top: 0,
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                ...
                {
                  className:
                    "flex items-center justify-between border-b border-white/[0.08] pb-6 mb-12",
                  children: [
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                            ...
                            {
                              fileName:
                                "/app/applet/src/components/services/ServicesInteractive.tsx",
                              lineNumber: 190,
                              columnNumber: 13,
                            },
                            this,
                          ...
                          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                            "p",
                            {
                              ...
                              children: "Core Disciplines & Capabilities",
                            },
                            void 0,
                            false,
                            {
                    ...
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                      ...
                      {
                        className:
                          "mono text-[10px] tracking-[0.2em] text-slate-500 uppercase hidden sm:block",
                        children: "Interactive Architecture",
                      },
                      void 0,
                      false,
                      {
                                ...
                                "div",
                                {
                                  ...
                                  children: [
                                              ...
                                              children: [
                                                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                  motion.span,
                                                  {
                                                    ...
                                                    className:
                                                      "mono text-sm md:text-base font-semibold tracking-wider transition-colors duration-300",
                                                ...
                                                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                  ...
                                                  {
                                                    className:
                                                      "display text-2xl sm:text-3xl md:text-4xl text-white font-medium tracking-tight group-hover:text-sky-200 transition-colors",
                                    ...
                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                      ...
                                      {
                                        className:
                                          "text-[13px] md:text-sm text-sky-300/80 font-medium tracking-wide",
                                        children: discipline.tagline,
                                      },
                                      void 0,
                                      false,
                                      {
                                    ...
                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                      ...
                                      {
                                        className:
                                          "text-[14px] md:text-[15px] leading-relaxed text-slate-300/90 font-normal",
                                        children: discipline.description,
                                      },
                                      void 0,
                                      false,
                                      {
                                    ...
                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                      ...
                                      {
                                        className:
                                          "pt-3 border-t border-white/[0.05] flex flex-wrap gap-2",
                                        children: discipline.deliverables.map((deliv) =>
                                          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                            "span",
                                            {
                                              className:
                                                "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-normal tracking-wide bg-white/[0.03] border border-white/[0.06] text-slate-300",
                                              children: [
                                                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                  Check,
                                                  { size: 11, className: "text-sky-400" },
                                                  void 0,
                                                  false,
                                                  {
                                                    fileName:
                                    ...
                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                      ...
                                      {
                                        className:
                                          "lg:hidden mt-3 pt-3 border-t border-white/[0.08]",
                                        children:
                                          matchedProject &&
                                          matchedProject.cover_url &&
                                          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                            "div",
                                            {
                                              className:
                                                "relative aspect-[16/9] w-full rounded-xl overflow-hidden border border-white/[0.1] bg-[#050a14]",
                                              children: [
                                                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                  "img",
                                                  {
                                                    ...
                                                    children: [
                                                        ...
                                                        "div",
                                                        {
                                                          children: [
                                                            ...
                                                            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                              ...
                                                              {
                                                                className:
                                                                  "mono text-[9px] text-sky-300 uppercase tracking-widest",
                                                                children: matchedProject.category,
                                                              },
                                                              void 0,
                                                              false,
                                                              {
                                                      ...
                                                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                        Link,
                                                        {
                                                          ...
                                                          className:
                                                            "px-2.5 py-1 rounded-full text-[10px] font-semibold bg-white text-black",
                                                          children: "Explore",
                                                        },
                                                        void 0,
                                                        false,
                    ...
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                          ...
                          {
                            className:
                              "relative rounded-2xl border border-white/[0.1] bg-[#030712] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.6)] overflow-hidden",
                            children: [
                              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                "div",
                                {
                                  className:
                                    "flex items-center justify-between mb-4 pb-3 border-b border-white/[0.08]",
                                  children: [
                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                      "div",
                                      {
                                        ...
                                        children: [
                                          ...
                                          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                            ...
                                            {
                                              className:
                                                "mono text-[10px] tracking-[0.2em] text-slate-400 uppercase",
                                              children: "Portfolio Reference",
                                            },
                                            void 0,
                                            false,
                                            {
                                    ...
                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                      ...
                                      {
                                        className:
                                          "mono text-[10px] tracking-[0.15em] text-sky-300 font-semibold uppercase",
                                        children: [currentDiscipline.number, " / 04"],
                                      },
                                      void 0,
                                      true,
                                      {
                              ...
                              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                ...
                                {
                                  className:
                                    "relative aspect-[4/3] w-full rounded-xl overflow-hidden border border-white/[0.08] bg-[#070e1c]",
                                  children: [
                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                      AnimatePresence,
                                      {
                                        ...
                                        children:
                                          matchedProject && matchedProject.cover_url
                                                  ...
                                                  children: [
                                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                      "img",
                                                      {
                                                        ...
                                                        alt: matchedProject.title,
                                                        className:
                                                          "w-full h-full object-cover transition-transform duration-700 ease-out hover:scale-105",
                                                      },
                                                      void 0,
                                                      false,
                                                      {
                                                    ...
                                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                      ...
                                                      {
                                                        className:
                                                          "absolute inset-0 bg-gradient-to-t from-[#030712] via-transparent to-transparent opacity-80",
                                                      },
                                                      void 0,
                                                      false,
                                                      {
                                            ...
                                            : /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                ...
                                                {
                                                  className:
                                                    "absolute inset-0 flex flex-col items-center justify-center p-6 text-center bg-gradient-to-br from-[#061122] to-[#02050c]",
                                                  children: [
                                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                      "span",
                                                      {
                                                        className:
                                                          "mono text-xs text-sky-300 uppercase tracking-widest mb-2",
                                                        children: currentDiscipline.title,
                                                      },
                                                      void 0,
                                                      false,
                                                      {
                                                    ...
                                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                      "p",
                                                      {
                                                        ...
                                                        children: currentDiscipline.tagline,
                                                      },
                                                      void 0,
                                                      false,
                                                      {
                                    ...
                                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                      "div",
                                      {
                                        ...
                                        children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                          ...
                                          {
                                            className:
                                              "mono inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[9px] font-semibold tracking-wider uppercase bg-black/60 text-white backdrop-blur-md border border-white/[0.15]",
                                            children: [
                                              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                                "span",
                                                {
                              ...
                              matchedProject &&
                                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                  ...
                                  {
                                    className:
                                      "mt-5 pt-4 border-t border-white/[0.08] flex items-center justify-between",
                                    children: [
                                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                        "div",
                                        {
                                          children: [
                                            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                              "h4",
                                              {
                                                className: "display text-lg text-white font-medium",
                                                children: matchedProject.title,
                                              },
                                              void 0,
                                              false,
                                            ...
                                            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                              ...
                                              {
                                                className:
                                                  "mono text-[11px] text-slate-400 tracking-wider uppercase mt-0.5",
                                                children: [
                                      ...
                                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                        Link,
                                        {
                                          to: "/portfolio/$slug",
                                          params: {
                                            slug: matchedProject.slug || matchedProject.id,
                                          },
                                          className:
                                            "group inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold text-white bg-white/[0.08] hover:bg-sky-400 hover:text-black border border-white/[0.12] transition-all duration-300",
                                          children: [
                                            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                              "span",
                                              { children: "View Case" },
...
function ServicesPage() {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    "div",
    {
      className: "bg-[var(--color-bg)] min-h-screen",
      children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "section",
          {
            className: "relative px-4 md:px-8 pt-44 md:pt-48 pb-12 md:pb-16 overflow-hidden",
            children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                    motion.div,
                    {
                      ...
                      className:
                        "flex items-start justify-between mono text-[10px] tracking-[0.28em] text-sky-300/75 uppercase mb-12",
                      children: [
                        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                          "div",
                          { children: "Methodology · Practice" },
                          void 0,
                          false,
                          {
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                    motion.h1,
                    {
                      ...
                      className:
                        "display text-[clamp(2.75rem,7vw+1rem,7.5rem)] leading-[0.96] tracking-[-0.025em] text-[var(--color-text-primary)] max-w-5xl",
                      children: [
                        "Visual capabilities &",
                        " ",
                        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                    motion.p,
                    {
                      ...
                      className:
                        "mt-8 max-w-2xl text-[16px] md:text-lg text-[var(--color-text-secondary)] leading-relaxed",
                      children:
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "section",
          {
            className: "relative px-4 md:px-8 py-32 border-t border-[var(--color-border-subtle)]",
            children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
              "div",
              {
                className: "max-w-[var(--width-standard)] mx-auto",
                children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                  motion.div,
                  {
                    initial: {
                    ...
                    children: [
                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                        ...
                        {
                          className:
                            "display text-4xl md:text-6xl mt-8 max-w-3xl mx-auto leading-[1.05] tracking-[-0.02em]",
                          children: [
                            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                              "span",
                              {
                                className: "text-[var(--color-text-primary)]",
                                children: ["Tell me about your brand and", " "],
                              },
                              void 0,
                              true,
                              {
                            ...
                            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                              "span",
                              {
                                className: "italic text-[var(--color-accent-hover)]",
                        ...
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                            Link,
                            {
                              to: "/contact",
                              className:
                                "group flex h-14 items-center gap-3 rounded-full bg-[var(--color-text-primary)] px-8 text-[15px] font-semibold text-[var(--color-bg)] transition-all hover:bg-sky-300 hover:text-black focus:outline-none",
                              children: [
                                ...
                                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                                  ...
                                  {
                                    fileName:
                                      "/app/applet/src/routes/services.tsx?tsr-split=component",
                                    lineNumber: 79,
                                    columnNumber: 17,
                                  },
                                  this,
