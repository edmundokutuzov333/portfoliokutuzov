...
const manifest = {
  ...
  "d1aab19b2ab28150ceb2b590995b3418b900aba58952db73f4f1c665ca4d5782": {
    ...
    importer: () => import("./newsletter.functions-BdhOOfFQ.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router--IsihV5_.mjs").then((n) => n.z),
    import("./start-gP0xSJr7.mjs"),
